...
import com.yiyanf.fang.util.EmoticonUtil;
...
public class TextMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        TextView tv = new TextView(FangApplication.getApplication());
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
        tv.setTextColor(ContextCompat.getColor(FangApplication.getApplication(),isSelf() ? R.color.white : R.color.black));
