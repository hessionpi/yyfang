...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        tv.setTextColor(ContextCompat.getColor(mContext,isSelf() ? R.color.white : R.color.black));
    ...
    public String getSummary() {
        return FangApplication.getApplication().getString(R.string.summary_voice);
    }
    ...
    private void playAudio(final AnimationDrawable frameAnimatio) {
        ...
        elem.getSound(new TIMValueCallBack<byte[]>() {
            ...
            public void onSuccess(byte[] bytes) {
                try{
                    File tempAudio = IMFileUtil.getTempFile(IMFileUtil.FileType.AUDIO);
