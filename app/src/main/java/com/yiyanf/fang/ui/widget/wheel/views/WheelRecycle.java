...
package com.yiyanf.fang.ui.widget.wheel.views;
...
public class WheelRecycle {
	 ...
	 * @param paramFirstItem
	 *            the number of first item in layout
	 * @param range
	 *            the range of current wheel items
	 * @return the new value of first item number
	 */
	public int recycleItems(LinearLayout layout, int paramFirstItem, ItemsRange range) {
		int firstItem = paramFirstItem;
		int index = paramFirstItem;
	 ...
	 */
	private List<View> addView(View view, List<View> paramCache) {
		List<View> cache = paramCache;
		if (cache == null) {
	 ...
	 *            the index of view
	 */
	private void recycleView(View view, int paramIndex) {
