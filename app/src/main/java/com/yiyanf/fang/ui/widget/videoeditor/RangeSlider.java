...
public class RangeSlider extends ViewGroup {
    ...
    public void setDuration(long time,int minTime,int maxTime) {
        mVideoDuration = time;
        float intDur=minTime;
       // float index = (float) (10000.0 / mVideoDuration * 100);
        float index = (float) (intDur / mVideoDuration * 100);
        minIndex = Math.round(index);
    ...
    protected void onDraw(Canvas canvas) {
       ...
       /* if (mRangeChangeListener != null) {
            mRangeChangeListener.onKeyUp(TYPE_RIGHT, 0, 50);
        }*/
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                x = (int) event.getX();
            /*    float a = (float) (10000.0 / mVideoDuration * getMeasuredWidth());
                float b = getMeasuredWidth() - x;
                int c = mRightThumb.getRangeIndex();
                int d = mLeftThumb.getRangeIndex();
                int e = (int) (10000.0 / mVideoDuration * 100);
                LogUtil.e(c + "+++++++++++++++++++++++++++++++++" + d + "++++++++++++++++++++++++++" + e);

                if (!mIsDragging && c - d > e) {
                    mIsDragging = true;
                }*/
             /*  int a= x - mOriginalX;
                LogUtil.e(mTouchSlop+"+++++++++++++++++++++++++++++++++" + a );*/
...
//            mRangeChangeListener.onRangeChange(this, type, mLeftThumb.getRangeIndex(), mRightThumb.getRangeIndex());
    ...
    private void releaseLeftThumb() {
        ...
        if (endIndex - index < minIndex) {
            index = index - (minIndex - (endIndex - index))-1;
        }
    ...
    private void releaseRightThumb() {
        ...
        if (index - endIndex < minIndex) {
            index = index + (minIndex - (index - endIndex))+1;
        }
      /*  if (index <= endIndex) {
            index = endIndex + 1;
        }*/
