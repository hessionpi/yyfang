...
public class ChatInput extends RelativeLayout implements TextWatcher,View.OnClickListener {
    ...
    private void initView(){
        textPanel = ButterKnife.findById(this,R.id.text_panel);
        btnAdd = ButterKnife.findById(this,R.id.btn_add);
        btnAdd.setOnClickListener(this);
        btnSend = ButterKnife.findById(this,R.id.btn_send);
        btnSend.setOnClickListener(this);
        btnVoice = ButterKnife.findById(this,R.id.btn_voice);
        btnVoice.setOnClickListener(this);
        btnEmotion = ButterKnife.findById(this,R.id.btnEmoticon);
        btnEmotion.setOnClickListener(this);
        morePanel = ButterKnife.findById(this,R.id.morePanel);
        LinearLayout BtnImage = ButterKnife.findById(this,R.id.btn_photo);
        BtnImage.setOnClickListener(this);
        LinearLayout BtnPhoto = ButterKnife.findById(this,R.id.btn_image);
        BtnPhoto.setOnClickListener(this);
        /*LinearLayout btnVideo = (LinearLayout) findViewById(R.id.btn_video);
        btnVideo.setOnClickListener(this);*/
        LinearLayout btnFile = ButterKnife.findById(this,R.id.btn_file);
        btnFile.setOnClickListener(this);
        setSendBtn();
        btnKeyboard = ButterKnife.findById(this,R.id.btn_keyboard);
        btnKeyboard.setOnClickListener(this);
        voicePanel = ButterKnife.findById(this,R.id.voice_panel);
