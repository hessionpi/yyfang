...
public class TemplateTitle extends RelativeLayout {
    ...
    public TemplateTitle(Context context, AttributeSet attrs) {
        ...
        try {
            titleText = ta.getString(R.styleable.TemplateTitle_title);
    ...
    private void setUpView(){
        TextView tvTitle = ButterKnife.findById(this,R.id.title);
        tvTitle.setText(titleText);
        LinearLayout backBtn = ButterKnife.findById(this,R.id.title_back);
        backBtn.setVisibility(canBack ? VISIBLE : INVISIBLE);
        if (canBack){
            TextView tvBack = ButterKnife.findById(this,R.id.txt_back);
        ...
        if (moreImg != 0){
            ImageView moreImgView = ButterKnife.findById(this,R.id.img_more);
            moreImgView.setImageDrawable(getContext().getResources().getDrawable(moreImg));
        }
        tvMore = ButterKnife.findById(this,R.id.txt_more);
