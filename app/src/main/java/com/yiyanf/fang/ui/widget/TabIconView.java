...
public class TabIconView extends LinearLayout {
    ...
    private void initViews() {
        ...
        tvText.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSizeDefault);
...
//            tvText.setTextColor(textColorPressed);
    ...
    private void readInParams(TypedArray typedArray) {
        ...
        textSizeDefault = typedArray.getDimensionPixelSize(R.styleable.TabIconView_textSizeDefault, textSizeDefault);
