...
//    private String textExpand;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = ContextCompat.getDrawable(getContext(),R.drawable.ic_play_video_desc_close);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_play_video_desc_expand);
        }
        ...
        contentTextColor = typedArray.getColor(R.styleable.ExpandableTextView_contentTextColor, ContextCompat.getColor(getContext(), R.color.white));
        contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_contentTextSize, PixelUtil.sp2px(14));
        ...
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView_collapseExpandTextSize, PixelUtil.sp2px(14));*/
    ...
    private void findViews() {
        ...
        mTvContent = ButterKnife.findById(this,R.id.expandable_text);
        mTvContent.setOnClickListener(this);
        mTvExpandCollapse = ButterKnife.findById(this,R.id.expand_collapse);
        setDrawbleAndText();
