...
public class MineVideoAdapter extends XMBaseAdapter<MineVideoInfo> {
    ...
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        return new VideoPublishHolder(parent, R.layout.item_recycler_mine_video);
    }

    private class VideoPublishHolder extends BaseViewHolder<MineVideoInfo> {
       ...
       /* ImageView mUserAvatar;
        ...
        @Override
        public void setData(MineVideoInfo data) {
            ...
            tv_play.setText(data.getPlaytimes()+"");
            tv_favorite.setText(data.getFavoritecount()+"");
            tv_share.setText(data.getSharecount()+"");
        }
    }
}
