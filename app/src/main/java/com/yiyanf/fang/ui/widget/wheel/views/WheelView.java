...
import com.yiyanf.fang.ui.widget.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	 ...
	 *            the animation flag
	 */
	public void setCurrentItem(int paramIndex, boolean animated) {
	 ...
	 */
	private View getItemView(int paramIndex) {
		int index = paramIndex;
		if (viewAdapter == null || viewAdapter.getItemsCount() == 0) {
			return null;
		}
