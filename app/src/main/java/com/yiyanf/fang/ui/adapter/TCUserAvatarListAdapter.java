...
public class TCUserAvatarListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ImageLoader.loadTransformImage(mContext,mUserAvatarList.get(position).headpic,R.drawable.icon_man,R.drawable.icon_man,((AvatarViewHolder)holder).ivAvatar,0);
    }
